...
from cdk.{{cookiecutter.service_name}}.lambda_managed_instance_construct import LambdaManagedInstanceConstruct
from cdk.{{cookiecutter.service_name}}.monitoring import CrudMonitoring
from cdk.{{cookiecutter.service_name}}.waf_construct import WafToApiGatewayConstruct
...
class ApiConstruct(Construct):
    ...
    def _add_get_lambda_integration(
        ...
        lambda_function = _lambda.Function(
            ...
            runtime=self.LAMBDA_RUNTIME,
            code=_lambda.Code.from_asset(constants.BUILD_FOLDER),
            handler='{{cookiecutter.service_name}}.handlers.handle_get_order.lambda_handler',
            environment={
    ...
    def _add_delete_lambda_integration(
        ...
        lambda_function = _lambda.Function(
            ...
            runtime=self.LAMBDA_RUNTIME,
            code=_lambda.Code.from_asset(constants.BUILD_FOLDER),
            handler='{{cookiecutter.service_name}}.handlers.handle_delete_order.lambda_handler',
            environment={
                constants.POWERTOOLS_SERVICE_NAME: constants.SERVICE_NAME,
                constants.POWER_TOOLS_LOG_LEVEL: 'INFO',
                'TABLE_NAME': db.table_name,
    ...
    def _add_list_lambda_integration(
        ...
        lambda_function = _lambda.Function(
            ...
            runtime=self.LAMBDA_RUNTIME,
            code=_lambda.Code.from_asset(constants.BUILD_FOLDER),
            handler='{{cookiecutter.service_name}}.handlers.handle_list_orders.lambda_handler',
            environment={
                constants.POWERTOOLS_SERVICE_NAME: constants.SERVICE_NAME,
                constants.POWER_TOOLS_LOG_LEVEL: 'INFO',
                'TABLE_NAME': db.table_name,
