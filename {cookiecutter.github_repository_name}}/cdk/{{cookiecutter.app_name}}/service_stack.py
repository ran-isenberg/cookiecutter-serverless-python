...
from cdk.{{cookiecutter.app_name}}.configuration.configuration_construct import ConfigurationStore
from cdk.{{cookiecutter.app_name}}.constants import CONFIGURATION_NAME, ENVIRONMENT, SERVICE_NAME
