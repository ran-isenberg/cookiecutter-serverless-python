...
from {{cookiecutter.app_name}}.handlers.schemas.env_vars import DynamicConfiguration
from {{cookiecutter.app_name}}.handlers.utils.env_vars_parser import get_environment_variables
